                    ...
                    <div class="basket__info" v-if="cartProducts.length > 0">
                        <form action="#" class="basket__info-form">
                            <div class="basket__form-left">
                                ...
                                <input type="text" class="form__input" placeholder="State">
                                <input type="number" class="form__input" placeholder="Postcode / Zip">
                            ...
                            <div class="basket__form-right">
                                ...
                                <input type="text" class="form__input coupon__input" placeholder="State">
                                <a href="#" class="form__button">Apply coupon</a>
                            </div>
                        </form>
                        <div class="checkout">
